...
class OpenContainerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('OpenContainer Animation')),
        body: GridView.count(
          crossAxisCount: 2,
              ...
              OpenContainer(
                closedBuilder: (_, openContainer) {
                  return GestureDetector(
                    onTap: openContainer,
                    child: ImageItem(url: OpenContainerImages.urls[index]),
                  );
                },
                openBuilder: (_, closeContainer) {
                  return LargeImagePage(
                      index: index, onPressed: closeContainer);
                },
    ...
    return Material(
      child: Scaffold(
          ...
          body: Padding(
            ...
            child: Hero(
              tag: OpenContainerImages.titles[index],
              child: Center(
                  child: ImageItem(
